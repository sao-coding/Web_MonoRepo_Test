...
export default function BarChartComponent({ filters, chartData, loading, error }: BarChartComponentProps) {
  const [activeTab] = useState<'bar' | 'pie'>('bar') // tab 狀態，預設為長條圖
  // 自定義 Tooltip
