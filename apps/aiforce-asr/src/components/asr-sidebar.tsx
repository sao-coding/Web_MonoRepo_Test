...
import { ChevronDown, InfoIcon, Moon, PanelLeft, Sun } from 'lucide-react'
...
import { translateConfig } from '@/config/asr'
...
interface AsrSidebarProps extends React.ComponentProps<typeof Sidebar> {
  /** Logo URL */
  logoUrl?: string
  /** 頁面標題 */
  title?: string
          ...
          <SidebarGroup>
            <SidebarGroupLabel asChild>
              <CollapsibleTrigger className='flex w-full items-center gap-1.5'>
                ...
                <span className='text-muted-foreground truncate text-xs font-medium'>識別紀錄</span>
              </CollapsibleTrigger>
            </SidebarGroupLabel>
